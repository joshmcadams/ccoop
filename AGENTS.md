...
* **Animation Sequencing:** The user loves logical, sequential construction animations (e.g., bolts staging on the grass, rising up, and shooting into the holes). Make it look like a highly satisfying step-by-step instruction manual.
