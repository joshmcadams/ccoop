...
* **Wall Plate & Cladding Alignment:** The wall frames will be built from standard 90x45mm timber, placed on top of the 17mm plywood floor. Even though the 90mm wall plate is wider than the 50mm joist beneath it, the outer 50mm sits firmly on the joist/bearer while the inner 40mm is supported by the rigid plywood. This allows the outside face of the wall studs, the edge of the plywood, and the outside face of the bearer to stack perfectly flush. The exterior cladding can then drop straight down over the entire assembly like a skirt, sealing out the weather completely.

## Roof & Nesting
* **Roof:** Sloped single-plane (skillion) roof to easily shed rain downhill.
* **Nesting Boxes:** Exterior protruding boxes to save interior floor space. Built with an overhanging, sloped lid (angled -15 degrees away from the coop).
